...
#define NUM_ADI_PORTS 8
    ...
    namespace c {
         ...
         *
         * This function uses the following values of errno when an error state
         * is reached: EINVAL - The given value is not within the range of ADI
         * Ports. EACCES - Another resource is currently trying to access the
         * ADI.
         *
         * \param port
...
#define OUTPUT_ANALOG 0x03
        ...
        /**
         * Calibrates the analog sensor on the specified port and returns the
         * new calibration value.
         *
         * This method assumes that the true sensor value is not actively
         * changing at this time and computes an average from approximately 500
         * samples, 1 ms apart, for a 0.5 s period of calibration. The average
         * value thus calculated is returned and stored for later calls to the
         * adi_analog_read_calibrated() and adi_analog_read_calibrated_HR()
         * functions. These functions will return the difference between this
         * value and the current sensor value when called.
         *
         ...
         * This function uses the following values of errno when an error state
         * is reached: EINVAL - The given value is not within the range of ADI
         * Ports, or the given port is not configured as an analog input. EACCES
         ...
         *
         * The value returned is undefined if the analog pin has been switched
         * to a different mode.
         *
         * This function uses the following values of errno when an error state
         * is reached: EINVAL - The given value is not within the range of ADI
         ...
         *
         * \param port
         *        The ADI port (from 1-8, 'a'-'h', 'A'-'H') for which the value
         * will be returned
         *
         * \return The analog sensor value, where a value of 0 reflects an input
         * voltage of nearly 0 V and a value of 4095 reflects an input voltage
         * of nearly 5 V
         */
         ...
         *
         * The adi_analog_calibrate() function must be run first. This function
         * is inappropriate for sensor values intended for integration, as
         * round-off error can accumulate causing drift over time. Use
         * adi_analog_read_calibrated_HR() instead.
         *
         * This function uses the following values of errno when an error state
         * is reached: EINVAL - The given value is not within the range of ADI
         * Ports, or the given port is not configured as an analog input. EACCES
         ...
         * will be returned
         *
         * \return The difference of the sensor value from its calibrated
         ...
         *
         * The adi_analog_calibrate() function must be run first. This is
         * intended for integrated sensor values such as gyros and
         * accelerometers to reduce drift due to round-off, and should not be
         * used on a sensor such as a line tracker or potentiometer.
         *
         * The value returned actually has 16 bits of "precision", even though
         * the ADC only reads 12 bits, so that error induced by the average
         * value being between two values when integrated over time is trivial.
        ...
        /**
         * Gets the digital value (1 or 0) of a port configured as a digital
         * input.
         *
         * If the port is configured as some other mode, the digital value which
         * reflects the current state of the poprt is returned, which may or may
         * not differ from the currently set value. The return value is
         * undefined for ports configured as any mode other than a Digital
         * Input.
         *
         * This function uses the following values of errno when an error state
         * is reached: EINVAL - The given value is not within the range of ADI
         * Ports, or the given port is not configured as a digital input. EACCES
         * - Another resource is currently trying to access the ADI.
         *
         * \param port
         ...
         * under the same circumstances, so only one task should call this
         * function for any given button. E.g., Task A calls this function for
         * buttons 1 and 2. Task B may call this function for button 3, but
         * should not for buttons 1 or 2. A typical use-case for this function
         * is to call inside opcontrol to detect new button presses, and not in
         * any other tasks.
         *
         * This function uses the following values of errno when an error state
         * is reached: EINVAL - The given value is not within the range of ADI
         ...
         * This function uses the following values of errno when an error state
         * is reached: EINVAL - The given value is not within the range of ADI
         * Ports, or the given port is not configured as a digital output.
         * EACCES - Another resource is currently trying to access the ADI.
         *
         * \param port
         *        The ADI port to read (from 1-8, 'a'-'h', 'A'-'H')
         * \param value
         *        An expression evaluating to "true" or "false" to set the
         * output to HIGH or LOW respectively, or the constants HIGH or LOW
         * themselves
         *
         * \return 1 if the operation was successful or PROS_ERR if the
         * operation failed, setting errno.
         ...
         *        The ADI port to read (from 1-8, 'a'-'h', 'A'-'H')
         * \param mode
         *        One of INPUT, INPUT_ANALOG, INPUT_FLOATING, OUTPUT, or
         * OUTPUT_OD
         *
         * \return 1 if the operation was successful or PROS_ERR if the
         * operation failed, setting errno.
         ...
         * This function uses the following values of errno when an error state
         * is reached: EINVAL - The given value is not within the range of ADI
         * Ports, or the given port is not configured as an ADI Motor. EACCES -
         * Another resource is currently trying to access the ADI.
         *
         * \param port
         ...
         *
         * This merely contains the port number for the encoder, unlike its use
         * as an object to store encoder data in PROS 2.
         */
         ...
         * This function uses the following values of errno when an error state
         * is reached: EINVAL - The given value is not within the range of ADI
         * Ports, or the given port is not configured as an ADI Encoder. EACCES
         * - Another resource is currently trying to access the ADI.
         *
         * \param enc
         *        The adi_encoder_t object from adi_encoder_init() to read
         *
         * \return The signed and cumulative number of counts since the last
         * start or reset
         */
         ...
         *
         * \param port_top
         *        The "top" wire from the encoder sensor with the removable
         * cover side UP \param port_bottom The "bottom" wire from the encoder
         * sensor \param reverse If "true", the sensor will count in the
         * opposite direction
         *
         * \return An adi_encoder_t object to be stored and used for later calls
         ...
         *
         * This merely contains the port number for the ultrasonic, unlike its
         * use as an object to store ultrasonic data in PROS 2.
         */
         ...
         *
         * If no object was found, zero is returned. If the ultrasonic sensor
         * was never started, the return value is undefined. Round and fluffy
         * objects can cause inaccurate values to be returned.
         *
         * This function uses the following values of errno when an error state
         * is reached: EINVAL - The given value is not within the range of ADI
         * Ports, or the given port is not configured as an ADI Ultrasonic.
         * EACCES - Another resource is currently trying to access the ADI.
         *
         * \param ult
         ...
         *
         * \param port_ping
         *        The port connected to the orange OUTPUT cable. This should be
         * in the next highest port following port_echo. \param port_echo The
         * port connected to the yellow INPUT cable. This should be in port 1,
         * 3, 5, or 7 ('A', 'C', 'E', 'G').
         *
         * \return An adi_ultrasonic_t object to be stored and used for later
         * calls to ultrasonic functions
         */
        adi_ultrasonic_t adi_ultrasonic_init(uint8_t port_ping,
                                             uint8_t port_echo);

        /**
         * Disables the ultrasonic sensor and voids the configuration on its
         * ports.
         *
         * This function uses the following values of errno when an error state
         * is reached: EINVAL - The given value is not within the range of ADI
         ...
         *
         * This merely contains the port number for the gyroscope, unlike its
         * use as an object to store gyro data in PROS 2.
         */
        typedef int32_t adi_gyro_t;

        /**
         * Gets the current gyro angle in tenths of a degree. Unless a
         * multiplier is applied to the gyro, the return value will be a whole
         * number representing the number of degrees of rotation times 10.
         *
         ...
         * This function uses the following values of errno when an error state
         * is reached: EINVAL - The given value is not within the range of ADI
         * Ports, or the given port is not configured as an ADI Gyro. EACCES -
         * Another resource is currently trying to access the ADI.
         *
         * \param gyro
         ...
         * previously been configured as a gyro, then this function starts a
         * 1300 ms calibration period.
         *
         * It is highly recommended that this function be called from
         * initialize() when the robot is stationary to ensure proper
         * calibration.
         *
         * This function uses the following values of errno when an error state
         * is reached: EINVAL - The given value is not within the range of ADI
         ...
         *
         * \param port
         *        The ADI port to initialize as a gyro (from 1-8, 'a'-'h',
         * 'A'-'H') \param multiplier A scalar value that will be multiplied by
         * the gyro heading value supplied by the ADI
         *
         * \return An adi_gyro_t object containing the given port, or PROS_ERR
