...
namespace lcd {
     ...
     *
     * Calling this function will clear the entire display, and you will not be
     * able to call any further LLEMU functions until another call to
     * lcd_initialize.
     *
...
#pragma GCC diagnostic pop
     ...
     *
     * When the rightmost button on the emulated three-button LCD is pressed,
     ...
     * button is pressed, 0 1 0 indicates the center button is pressed, and 0 0
     * 1 indicates the right button is pressed. 0 is returned if no buttons are
