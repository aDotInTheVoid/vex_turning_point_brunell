...
namespace pros {
    namespace c {
         ...
         *
         * This is designed to map easily to the input from the controller's
         * analog stick for simple opcontrol use. The actual behavior of the
         * motor is analogous to use of motor_move_voltage(), or motorSet() from
         * the PROS 2 API.
         *
         * This function uses the following values of errno when an error state
         * is reached: EINVAL - The given value is not within the range of V5
         * ports (1-21). EACCES - Another resource is currently trying to access
         * the port.
         *
         * \param port
         ...
         *
         * This movement is relative to the position of the motor when
         ...
         *
         * This movement is relative to the current position of the motor as
         * given in motor_get_position(). Providing 10.0 as the position
         * parameter would result in the motor moving clockwise 10 units, no
         * matter what the current position is.
         *
         * \note This function simply sets the target for the motor, it does not
         * block program execution until the movement finishes.
         *
         ...
         * velocity is held with PID to ensure consistent speed, as opposed to
         ...
         *        The V5 port number from 1-21
         * \param velocity
         *        The new motor velocity from +-100, +-200, or +-600 depending
        ...
        /** **/
        /**    These functions allow programmers to collect telemetry from
         * motors    **/
        /******************************************************************************/
         ...
         *        The V5 port number from 1-21
         *
         * \return The motor's current in mA or PROS_ERR if the operation
         ...
         * negative direction, or PROS_ERR if the operation failed, setting
         * errno.
         */
         ...
         *
         * An efficiency of 100% means that the motor is moving electrically
         * while drawing no electrical power, and an efficiency of 0% means that
         * the motor is drawing power but not moving.
         *
         * This function uses the following values of errno when an error state
         * is reached: EINVAL - The given value is not within the range of V5
         * ports (1-21). EACCES - Another resource is currently trying to access
         ...
         * presently does not provide any value. This function returns PROS_ERR
         ...
         *        The V5 port number from 1-21
         *
         * \return 1 if the motor is at zero absolute position, 0 if the motor
         * has moved from its absolute zero, or PROS_ERR if the operation
         * failed, setting errno
         */
...
#define MOTOR_FLAGS_ZERO_POSITION E_MOTOR_FLAGS_ZERO_POSITION
    ...
    namespace c {
         ...
         * count will be returned. If NULL, the timestamp at which the encoder
         *            count was read will not be supplied
         *
         * \return The raw encoder count at the given timestamp or PROS_ERR if
         ...
         *        The V5 port number from 1-21
         *
         * \return The motor's power draw in Watts or PROS_ERR_F if the
         * operation failed, setting errno.
         */
         ...
         *        The V5 port number from 1-21
         *
         * \return The motor's temperature in degrees Celsius or PROS_ERR_F if
         ...
         *        The V5 port number from 1-21
         *
         * \return The motor's torque in Nm or PROS_ERR_F if the operation
         * failed, setting errno.
         */
         ...
         *        The V5 port number from 1-21
         *
         * \return The motor's voltage in mV or PROS_ERR_F if the operation
         * failed, setting errno.
         */
        ...
        /** **/
        /**  These functions allow programmers to configure the behavior of
         * motors   **/
        /******************************************************************************/
    ...
    typedef enum motor_brake_mode_e {
        E_MOTOR_BRAKE_COAST =
            0,  // Motor coasts when stopped, traditional behavior
    ...
    typedef enum motor_encoder_units_e {
        E_MOTOR_ENCODER_DEGREES = 0,  // Position is recorded as angle in
        ...
        E_MOTOR_ENCODER_COUNTS = 2,  // Position is recorded as raw encoder
                                     // ticks as a whole number
...
#define MOTOR_GEARSET_INVALID E_MOTOR_GEARSET_INVALID
     ...
     *
     * These values are in 4.4 format, meaning that a value of 0x20
     * represents 2.0, 0x21 represents 2.0625, 0x22 represents 2.125, etc.
     */
    typedef struct motor_pid_full_s {
        ...
        uint8_t  threshold;  // The threshold for determining if a position
                            // movement has reached its goal. This has no effect
                            // for velocity PID calculations.
        uint8_t
    ...
    namespace c {
         ...
         * struct. The motor_pid_s_t struct is in 4.4 format, i.e. 0x20 is 2.0,
         * 0x21 is 2.0625, etc. This function will convert the floating point
         * values to the nearest 4.4 value.
         *
         * This function uses the following values of errno when an error state
         * is reached: EINVAL - The given value is not within the range of V5
         * ports (1-21). EACCES - Another resource is currently trying to access
         ...
         */
        motor_pid_s_t motor_convert_pid(double kf, double kp, double ki,
                                        double kd);
         ...
         * \return A motor_pid_s_t struct formatted properly in 4.4.
         */
        motor_pid_full_s_t motor_convert_pid_full(double kf, double kp,
                                                  double ki, double kd,
                                                  double filter, double limit,
                                                  double threshold,
                                                  double loopspeed);

        /**
         * Sets one of motor_pid_s_t for the motor. This intended to just modify
         * the main PID constants.
         *
         * Only non-zero values of the struct will change the existing motor
         * constants.
         *
         * \note This feature is in beta, it is advised to use caution when
         * modifying the PID values. The motor could be damaged by particularly
         * large constants.
         *
         * This function uses the following values of errno when an error state
         * is reached: EINVAL - The given value is not within the range of V5
         ...
         *
         * This will invert its movements and the values returned for its
         * position.
         *
         * This function uses the following values of errno when an error state
         * is reached: EINVAL - The given value is not within the range of V5
         ...
         *        The V5 port number from 1-21
         *
         * \return One of motor_brake_mode_e_t, according to what was set for
         * the motor, or E_MOTOR_BRAKE_INVALID if the operation failed, setting
         * errno.
         */
         ...
         *        The V5 port number from 1-21
         *
         * \return One of motor_encoder_units_e_t according to what is set for
         * the motor or E_MOTOR_ENCODER_INVALID if the operation failed.
         */
         ...
         *        The V5 port number from 1-21
         *
         * \return One of motor_gearset_e_t according to what is set for the
         * motor, or E_GEARSET_INVALID if the operation failed.
         */
         ...
         * the port.
         *
         * Additionally, in an error state all values of the returned struct are
         * set to their negative maximum values.
         *
         * \param port
         *        The V5 port number from 1-21
         *
         * \return A motor_pid_full_s_t containing the position PID constants
         * last set to the given motor
         */
         ...
         *        The V5 port number from 1-21
         *
         * \return A motor_pid_full_s_t containing the velocity PID constants
         * last set to the given motor
         */
