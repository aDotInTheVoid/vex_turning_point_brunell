...
#define CURRENT_TASK ((task_t) NULL)
    ...
    namespace c {
         ...
         * is reached: ENOMEM - The stack cannot be used as the TCB was not
         * created.
         *
         * \param function
         *        Pointer to the task entry function
         * \param parameters
         *        Pointer to memory that will be used as a parameter for the
         * task being created. This memory should not typically come from stack,
         * but rather from dynamically (i.e., malloc'd) or statically allocated
         * memory. \param prio The priority at which the task should run.
         *        TASK_PRIO_DEFAULT plus/minus 1 or 2 is typically used.
         * \param stack_depth
         *        The number of words (i.e. 4 * stack_depth) available on the
         * task's stack. TASK_STACK_DEPTH_DEFAULT is typically sufficienct.
         * \param name
         *        A descriptive name for the task.  This is mainly used to
         * facilitate debugging. The name may be up to 32 characters long.
         *
         * \return A handle by which the newly created task can be referenced.
         * If an error occurred, NULL will be returned and errno can be checked
         * for hints as to why task_create failed.
         */
         ...
         * event lists.
         *
         * Memory dynamically allocated by the task is not automatically freed,
         * and should be freed before the task is deleted.
         *
         * \param task
         ...
         *
         * The task will be woken up at the time *prev_time + delta, and
         * *prev_time will be updated to reflect the time at which the task will
         * unblock.
         *
         * \param prev_time
         *        A pointer to the location storing the setpoint time. This
         * should typically be initialized to the return value of millis().
         * \param delta
         *        The number of milliseconds to wait (1000 milliseconds per
         * second)
         */
        ...
        /**
         * Gets the number of tasks the kernel is currently managing, including
         * all ready, blocked, or suspended tasks. A task that has been deleted,
         * but not yet reaped by the idle task will also be included in the
         * count. Tasks recently created may take one context switch to be
         * counted.
         *
         ...
         *
         * The operation takes a relatively long time and should be used
         * sparingly.
         *
         * \param name
         *        The name to query
         *
         * \return A task handle with a matching name, or NULL if none were
         * found.
         */
         ...
         * Will also retrieve the value of the notification in the target task
         * before modifying the notification value.
         *
         * See
         * https://pros.cs.purdue.edu/v5/tutorials/topical/notifications.html
         * for details.
         ...
         * without needing to overwrite, 1 otherwise. For all other
         * NOTIFY_ACTION values: always return 0
         */
        uint32_t task_notify_ext(task_t task, uint32_t value,
         ...
         *        The task to clear
         *
         * \return False if there was not a notification waiting, true if there
         * was
         */
         ...
         * for details.
         *
         * \return A handle to a newly created mutex. If an error occurred, NULL
         * will be returned and errno can be checked for hints as to why
         * mutex_create failed.
         */
         ...
         * \param timeout
         *        Time to wait before the mutex becomes available. A timeout of
         * 0 can be used to poll the mutex. TIMEOUT_MAX can be used to block
         *        indefinitely.
         *
         * \return True if the mutex was successfully taken, false otherwise. If
         * false is returned, then errno is set with a hint about why the the
