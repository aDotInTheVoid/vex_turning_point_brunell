...
namespace pros {
    ...
    typedef struct __attribute__((__packed__)) vision_object {
        ...
        int16_t height;
        // Angle of a color code object in 0.1 degree units (e.g. 10 -> 1
        // degree, 155
        // -> 15.5 degrees)
        uint16_t angle;

        // coordinates of the middle of the object (computed from the values
        // above)
    ...
    typedef enum vision_zero {
        E_VISION_ZERO_TOPLEFT =
            0,                    // (0,0) coordinate is the top left of the FOV
...
#define VISION_ZERO_CENTER E_VISION_ZERO_CENTER
    ...
    namespace c {
        ...
        /**
         * Creates a color code that represents a combination of the given
         * signature IDs. If fewer than 5 signatures are to be a part of the
         * color code, pass 0 for the additional function parameters.
         *
         * This function uses the following values of errno when an error state
         * is reached: EINVAL - Fewer than two signatures have been provided, or
         * one of the signatures is out of its [1-7] range.
         *
         * \param port
         *        The V5 port number from 1-21
         * \param sig_id1
         ...
         * is reached: EINVAL - The given value is not within the range of V5
         * ports (1-21). EACCES - Another resource is currently trying to access
         * the port. EDOM - size_id is greater than the number of available
         * objects. EHOSTDOWN - Reading the vision sensor failed for an unknown
         * reason.
         *
         * \param port
         *        The V5 port number from 1-21
         ...
         *
         * \return The vision_object_s_t object corresponding to the given size
         * id, or PROS_ERR if an error occurred.
         */
        vision_object_s_t vision_get_by_size(uint8_t        port,
                                             const uint32_t size_id);

        /**
         * Gets the nth largest object of the given signature according to
         * size_id.
         *
         * This function uses the following values of errno when an error state
         * is reached: EINVAL - The given value is not within the range of V5
         ...
         *
         * \return The vision_object_s_t object corresponding to the given
         * signature and size_id, or PROS_ERR if an error occurred.
         */
        ...
        /**
         * Gets the nth largest object of the given color code according to
         * size_id.
         *
         * This function uses the following values of errno when an error state
         * is reached: EINVAL - The given value is not within the range of V5
         * ports (1-21). EACCES - Another resource is currently trying to access
         * the port. EAGAIN - Reading the Vision Sensor failed for an unknown
         * reason.
         *
         * \param port
         *        The V5 port number from 1-21
         ...
         */
        vision_object_s_t
        vision_get_by_code(uint8_t port, const uint32_t size_id,
         ...
         *        The V5 port number from 1-21
         *
         * \return The current exposure setting from [0,150], PROS_ERR if an
         * error occurred
         */
         ...
         *        The V5 port number from 1-21
         *
         * \return The number of objects detected on the specified vision
         * sensor. Returns PROS_ERR if the port was invalid or an error
         * occurred.
         */
         ...
         * This function uses the following values of errno when an error state
         * is reached: EINVAL - The given value is not within the range of V5
         * ports (1-21), or fewer than object_count number of objects were
         * found. EACCES - Another resource is currently trying to access the
         * port. EDOM - size_id is greater than the number of available objects.
         *
         * \param port
         *        The V5 port number from 1-21
         * \param size_id
         ...
         *
         * \return The number of object signatures copied. This number will be
         * less than object_count if there are fewer objects detected by the
         * vision sensor. Returns PROS_ERR if the port was invalid, an error
         * occurred, or fewer objects than size_id were found. All objects in
         * object_arr that were not found are given VISION_OBJECT_ERR_SIG as
         * their signature.
         */
        ...
        /**
         * Stores the supplied object detection signature onto the vision
         * sensor.
         *
         * NOTE: This saves the signature in volatile memory, and the signature
         * will be lost as soon as the sensor is powered down.
         *
         * \param port
         *        The V5 port number from 1-21
         * \param signature_id
         ...
         *
         * This functions uses the following values of errno when an error state
         * is reached: EINVAL - The given port is not within the range of V5
         * ports (1-21) EACCESS - Anothe resources is currently trying to access
         * the port
         *
         * \param port
         *        The V5 port number from 1-21
         * \param enable
         *        Disable Wi-Fi on the Vision sensor if 0, enable otherwise
         * (e.g. 1)
         *
         * \return 1 if the operation was successful or PROS_ERR if the
         * operation failed, setting errno.
